...
def test_r2scan3c():
    ...
    res = model.get_dispersion(DampingParam(s8=0.0, a1=0.42, a2=5.65, s9=2.0), grad=False)

    assert approx(res.get_energy(), abs=thr) == -0.008016697276824889

    res = model.get_dispersion(DampingParam(s8=0.0, a1=0.42, a2=5.65, s9=2.0), grad=True)
