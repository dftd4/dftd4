...
! SEC O2  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data secq   (9)   /    0.0000000 /; data sscale(9)/  0.5000000/
      data seccnD3(9)   /    0.9990000 /; data seccn (9)/  0.9800000/
     data secaiw (:,9)  /                                              &
...
! REF N2  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data secq   (10)   /    0.0000000 /; data sscale(9)/  0.5000000/
      data seccnD3(10)   /    1.0000000 /; data seccn (9)/  0.9810000/
     data secaiw (:,10)  /                                              &
...
! REF F2  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data secq   (11)   /    0.0000000 /; data sscale(11)/  0.5000000/
      data seccnD3(11)   /    0.9790000 /; data seccn (11)/  0.9610000/
     data secaiw (:,11)  /                                              &
...
! SEC Cl2 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data secq   (17)   /    0.0000000 /; data sscale(17)/  0.5000000/
      data seccnD3(17)   /    0.9950000 /; data seccn (17)/  0.9770000/
     data secaiw (:,17)  /                                              &
     &       30.5968154,    30.2907908,    29.4281025,    26.5588368,   &
     &       23.0571447,    19.6470649,    16.6420247,    14.1130996,   &
     &       12.0267253,    10.3165485,     8.9140109,     7.7590140,   &
     &        6.0042243,     4.7671234,     3.8705622,     3.2039005,   &
     &        2.6965878,     1.8588040,     1.3665825,     0.8411737,   &
     &        0.5795824,     0.2981883,     0.1870572              /
! REF H - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF Cu2Cl2  - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 29) /      0.24200000000000_wp /
      data refh    (3, 29) /     -0.24200000000000_wp /
      data gffq    (3, 29) /      0.24200000000000_wp /
      data gffh    (3, 29) /     -0.24200000000000_wp /
      data dftq    (3, 29) /      0.24200000000000_wp /
      data dfth    (3, 29) /     -0.24200000000000_wp /
      data pbcq    (3, 29) /      0.04000000000000_wp /
      data pbch    (3, 29) /     -0.04000000000000_wp /
      data clsq    (3, 29) /      0.04000000000000_wp /
      data clsh    (3, 29) /     -0.04000000000000_wp /
      data hcount  (3, 29) /      2.00000000000000_wp /
      data ascale  (3, 29) /      0.50000000000000_wp /
      data refcovcn(3, 29) /      2.89600000000000_wp /
      data refcn   (3, 29) /      3.72300000000000_wp /
      data refsys (3, 29) /    17 /
      data alphaiw(:,3, 29) /                                            &
     &       58.0827612_wp,    57.1557386_wp,    54.6729149_wp,    47.4160823_wp,   &
     &       39.8752577_wp,    33.3824857_wp,    28.1144977_wp,    23.9044008_wp,   &
     &       20.5361481_wp,    17.8221675_wp,    15.6148757_wp,    13.8016072_wp,   &
     &       11.0362134_wp,     9.0599413_wp,     7.5982368_wp,     6.4842664_wp,   &
     &        5.3702961_wp,     4.2563258_wp,     3.1423555_wp,     2.0283852_wp,   &
     &        1.4601793_wp,     0.7678649_wp,     0.4791961_wp              /
      data refn(29) / 3 /
! REF Zn  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF Zn4Cl8  - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 30) /      0.30218403508793_wp /
      data refh    (3, 30) /     -0.15109201734779_wp /
      data gffq    (3, 30) /      0.44738462968694_wp /
      data gffh    (3, 30) /     -0.22369231484347_wp /
      data dftq    (3, 30) /      0.30218403508793_wp /
      data dfth    (3, 30) /     -0.15109201734779_wp /
      data pbcq    (3, 30) /      0.40100000000000_wp /
      data pbch    (3, 30) /     -0.20050000000000_wp /
      data clsq    (3, 30) /      0.40100000000000_wp /
      data clsh    (3, 30) /     -0.20050000000000_wp /
      data hcount  (3, 30) /      8.00000000000000_wp /
      data ascale  (3, 30) /      0.25000000000000_wp /
      data refcovcn(3, 30) /      2.99100000000000_wp /
      data refcn   (3, 30) /      3.97300000000000_wp /
      data refsys (3, 30) /   17 /
      data alphaiw(:,3, 30) /                                            &
     &      196.6440081_wp,   191.8902033_wp,   181.5444617_wp,   156.3472476_wp,   &
     &      131.9134808_wp,   110.8595909_wp,    93.4667577_wp,    79.3120628_wp,   &
     &       67.8307614_wp,    58.4962813_wp,    51.3549763_wp,    45.4135399_wp,   &
     &       36.2273847_wp,    29.5789310_wp,    23.3327358_wp,    19.7449941_wp,   &
     &       16.7754492_wp,    11.9906895_wp,     9.0587488_wp,     5.6925166_wp,   &
     &        3.9301531_wp,     2.1579237_wp,     1.3566562_wp              /
      data refn(30) / 3 /
! REF Ga  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF Ag4Cl4  - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 47) /      0.33779384122334_wp /
      data refh    (3, 47) /     -0.33779384122334_wp /
      data gffq    (3, 47) /      0.28957980976738_wp /
      data gffh    (3, 47) /     -0.28957980976738_wp /
      data dftq    (3, 47) /      0.33779384122334_wp /
      data dfth    (3, 47) /     -0.33779384122334_wp /
      data pbcq    (3, 47) /      0.22600000000000_wp /
      data pbch    (3, 47) /     -0.22600000000000_wp /
      data clsq    (3, 47) /      0.22600000000000_wp /
      data clsh    (3, 47) /     -0.22600000000000_wp /
      data hcount  (3, 47) /      4.00000000000000_wp /
      data ascale  (3, 47) /      0.25000000000000_wp /
      data refcovcn(3, 47) /      2.74500000000000_wp /
      data refcn   (3, 47) /      3.68800000000000_wp /
      data refsys (3, 47) /   17 /
      data alphaiw(:,3, 47) /                                            &
     &      138.5450472_wp,   136.2158969_wp,   130.0953119_wp,   112.9411035_wp,   &
     &       95.6711499_wp,    80.8712222_wp,    68.7974041_wp,    59.0731526_wp,   &
     &       51.2269853_wp,    44.8455152_wp,    39.6013814_wp,    35.2445219_wp,   &
     &       28.4827883_wp,    23.5329017_wp,    19.7905977_wp,    16.8858236_wp,   &
     &       14.5821236_wp,    10.5373239_wp,     7.9721075_wp,     5.0233417_wp,   &
     &        3.4585054_wp,     1.7135123_wp,     1.0273278_wp              /
      data refn(47) / 3 /
! REF Cd  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF Cd3Cl6  - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 48) /      0.45400000000000_wp /
      data refh    (3, 48) /     -0.15133300000000_wp /
      data gffq    (3, 48) /      0.45393079307612_wp /
      data gffh    (3, 48) /     -0.15133300000000_wp /
      data dftq    (3, 48) /      0.45400000000000_wp /
      data dfth    (3, 48) /     -0.15133300000000_wp /
      data pbcq    (3, 48) /      0.34700000000000_wp /
      data pbch    (3, 48) /     -0.17300000000000_wp /
      data clsq    (3, 48) /      0.34700000000000_wp /
      data clsh    (3, 48) /     -0.17300000000000_wp /
      data hcount  (3, 48) /      6.00000000000000_wp /
      data ascale  (3, 48) /      0.33333333333333_wp /
      data refcovcn(3, 48) /      3.93600000000000_wp /
      data refcn   (3, 48) /      5.48000000000000_wp /
      data refsys (3, 48) /   17 /
      data alphaiw(:,3, 48) /                                            &
     &      164.9445638_wp,   160.3820112_wp,   150.1714292_wp,   126.9815888_wp,   &
     &      106.7570066_wp,    90.2221165_wp,    76.7933081_wp,    65.8661197_wp,   &
     &       56.9393561_wp,    49.6091857_wp,    43.5528294_wp,    38.5140505_wp,   &
     &       30.7235096_wp,    25.0851276_wp,    20.8847521_wp,    17.6734228_wp,   &
     &       15.1621813_wp,    10.8375642_wp,     8.1535419_wp,     5.1236847_wp,   &
     &        3.5374276_wp,     1.7779551_wp,     1.0820305_wp              /
      data refn(48) / 3 /
! REF In  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF AuCl2 - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 79) /      0.43856855018487_wp /
      data refh    (3, 79) /     -0.14618951672829_wp /
      data gffq    (3, 79) /      0.43856855018487_wp /
      data gffh    (3, 79) /     -0.14618951672829_wp /
      data dftq    (3, 79) /      0.43856855018487_wp /
      data dfth    (3, 79) /     -0.14618951672829_wp /
      data pbcq    (3, 79) /      0.36800000000000_wp /
      data pbch    (3, 79) /     -0.14800000000000_wp /
      data clsq    (3, 79) /      0.36800000000000_wp /
      data clsh    (3, 79) /     -0.14800000000000_wp /
      data hcount  (3, 79) /      3.00000000000000_wp /
      data ascale  (3, 79) /      1.00000000000000_wp /
      data refcovcn(3, 79) /      3.48900000000000_wp /
      data refcn   (3, 79) /      4.01000000000000_wp /
      data refsys (3, 79) /   17 /
      data alphaiw(:,3, 79) /                                           &
     &       61.4911730,    59.5766377,    55.2089014,    45.8362158,   &
     &       38.3991028,    32.6339942,    28.0418756,    24.3109760,   &
     &       21.2430021,    18.6987864,    16.4160133,    14.5167875,   &
     &       11.5803623,     9.4551329,     8.3082674,     7.0307525,   &
     &        6.0906928,     4.3534814,     3.2616840,     2.0496418,   &
     &        1.4150870,     0.6510630,     0.3835542              /
      data refn(79) / 3 /
! REF Hg  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
...
! REF Hg4F8 - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
      data refq    (3, 80) /      0.49100000000000_wp /
      data refh    (3, 80) /     -0.24550000000000_wp /
      data gffq    (3, 80) /      0.49100000000000_wp /
      data gffh    (3, 80) /     -0.24550000000000_wp /
      data dftq    (3, 80) /      0.49100000000000_wp /
      data dfth    (3, 80) /     -0.24550000000000_wp /
      data pbcq    (3, 80) /      0.36400000000000_wp /
      data pbch    (3, 80) /     -0.18200000000000_wp /
      data clsq    (3, 80) /      0.36400000000000_wp  /
      data clsh    (3, 80) /     -0.18200000000000_wp  /
      data hcount  (3, 80) /      8.00000000000000_wp /
      data ascale  (3, 80) /      0.25000000000000_wp /
      data refcovcn(3, 80) /      5.18800000000000_wp /
      data refcn   (3, 80) /      7.58200000000000_wp /
      data refsys (3, 80) /    11 /
      data alphaiw(:,3, 80) /                                            &
     &      129.1310860_wp,   119.1678326_wp,   107.1088191_wp,    90.2078418_wp,   &
     &       77.6569059_wp,    67.8424131_wp,    59.9947715_wp,    53.5855919_wp,   &
     &       48.2495821_wp,    43.7325273_wp,    39.8548327_wp,    36.4871943_wp,   &
     &       33.4041133_wp,    26.5293406_wp,    21.0694386_wp,    20.0784460_wp,   &
     &       17.6705701_wp,    15.5514549_wp,    10.1850500_wp,     6.5406592_wp,   &
     &        4.5263747_wp,     2.2230712_wp,     1.3108038_wp              /
      data refn(80) / 3 /
! REF Tl  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 1906
