...
subroutine test_dftd4_pbc
   ...
   real(wp),parameter :: g_c = 2.0_wp
   real(wp),parameter :: wf  = 6.0_wp
   integer, parameter :: lmbd = 0!p_mbd_approx_atm
   integer, parameter :: refqmode = p_refq_goedecker
   ...
   call pbc_dncoord_d4(mol,covcn,dcovcndr,dcovcndL,cn_rep,rthr_cn)
...
!   print*
   ...
   call generate_wsc(mol,mol%wsc,wsc_rep)
         ...
         call pbc_derfcoord(mol,cn,dcndr,dcndL,900.0_wp)
         call eeq_chrgeq(chrgeq,mol,cn,dcndr,dcndL,qr,dqdr,dqdL,er,ges,stmp,&
            &            .false.,.false.,.false.)
         call pbc_dncoord_d4(mol,covcn,dcovcndr,dcovcndL,cn_rep,rthr_cn)

         er = 0.0_wp
         call dispgrad_3d(mol,ndim,q,covcn,dcovcndr,dcovcndL,vdw_rep,cn_rep, &
            &             rthr_vdw,rthr_cn,dparam_pbe, &
            &             wf,g_a,g_c,refc6,lmbd,ges,stmp,er,dqdr,dqdL)
   ...
   call generate_wsc(mol,mol%wsc,wsc_rep)
         ...
         call pbc_derfcoord(mol,cn,dcndr,dcndL,900.0_wp)
         call eeq_chrgeq(chrgeq,mol,cn,dcndr,dcndL,ql,dqdr,dqdL,el,ges,stmp,&
            &            .false.,.false.,.false.)
         call pbc_dncoord_d4(mol,covcn,dcovcndr,dcovcndL,cn_rep,rthr_cn)
         ...
         call dispgrad_3d(mol,ndim,q,covcn,dcovcndr,dcovcndL,vdw_rep,cn_rep, &
            &             rthr_vdw,rthr_cn,dparam_pbe, &
            &             wf,g_a,g_c,refc6,lmbd,ges,stmp,el,dqdr,dqdL)
