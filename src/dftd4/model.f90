...
!> @dir dftd4/model
!> Contains the implementation of the specific D4 dispersion models.

!> @file tblite/model.f90
!> Provides the abstract base class for the dispersion model
...
module dftd4_model
   ...
   abstract interface
      ...
      subroutine weight_references(self, mol, cn, q, gwvec, gwdcn, gwdq)
         import base_d4_model, structure_type, wp
         !> Instance of the dispersion model
         class(base_d4_model), intent(in) :: self
